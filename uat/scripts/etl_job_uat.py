...
glueContext.write_dynamic_frame.from_jdbc_conf(
    ...
    catalog_connection="uat-redshift-connection",
    connection_options={"dbtable": "bronze.sales", "database": "dev"},
    redshift_tmp_dir="s3://uat-bucket-tl/temp/",
...
gold_df.coalesce(1).write.mode("overwrite").option("header", "true").csv("s3://uat-bucket-tl/output/gold_transformed_data")
